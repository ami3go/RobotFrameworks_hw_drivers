"""Typed result models returned by the PicoScope 2000A core driver."""
...
class InstrumentIdentity:
    """Parsed ``ps2000aGetUnitInfo`` fields for a connected unit."""
...
class ChannelSettings:
    ...
    ``picosdk.ps2000a`` has no "get channel" query — ``ps2000aSetChannel`` is
    ...
    ``probe_type="CURRENT"``, and :meth:`~picoscope2000a.driver.PicoScope2000A.get_waveform`
...
class Measurements:
    ...
    captured to measure it). See :mod:`picoscope2000a.measurements` for the
...
class TimebaseSettings:
    """Current block-capture timebase, as resolved by ``ps2000aGetTimebase2``."""
...
class TriggerSettings:
    ...
    ``ps2000aSetSimpleTrigger`` has no query counterpart.
    """
...
class AWGSettings:
    ...
    "get siggen" query — ``ps2000aSetSigGenBuiltIn`` is write-only.
    """
