...
from .exceptions import PicoScopeConnectionError
...
# ps2000a device in this simulator to ask; :class:`~picoscope_scope.backend.RealPs2000aBackend`
...
class SimulatedBackend:
    """Implements :class:`~picoscope_scope.backend.PicoScopeBackend` against a :class:`SimulatedBus`."""
