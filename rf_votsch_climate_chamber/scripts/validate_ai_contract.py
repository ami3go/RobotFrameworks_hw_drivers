...
contract=yaml.safe_load((ROOT/'ai/votsch_climate_chamber_ai_contract.yaml').read_text())
...
errors=[]
if lock['sha256']!=hashlib.sha256((ROOT/'ai/votsch_climate_chamber_ai_contract.yaml').read_bytes()).hexdigest(): errors.append('AI contract hash mismatch')
