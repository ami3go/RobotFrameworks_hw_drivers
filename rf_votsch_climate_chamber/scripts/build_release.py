...
def main() -> int:
    ...
    shutil.copyfile(ROOT / "ai/ai_contract.yaml", ROOT / "rf_votsch_climate_chamber/resources/ai_contract.yaml")
    shutil.copyfile(ROOT / "ai/ai_contract.lock", ROOT / "rf_votsch_climate_chamber/resources/ai_contract.lock")
