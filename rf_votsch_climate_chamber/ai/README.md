...
- `ai_contract.yaml` is JSON-compatible YAML and defines every public Robot keyword, state, resource, error, safety rule, oracle, and planning constraint.
- `ai_contract.lock` records the SHA-256 of the contract and the exact public keyword manifest.
