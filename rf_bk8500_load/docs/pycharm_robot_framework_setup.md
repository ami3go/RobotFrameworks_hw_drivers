...
**Package used by this guide:** `bk8500-load==26.16.0`. The release retains the hardware-verified v26.14 protocol path and adds optional automatic baud detection.
